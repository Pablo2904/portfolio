      ...
      <div className="row">
        ...
        <div className="col-12 col-sm-10 col-lg-8 mb-5 ">
          <img
            src={myAvatar}
            alt="Avatar"
            className="aboutWrapper__img mx-auto d-block img-fluid"
          />
          ...
          <div className="aboutWrapper__info mx-auto mt-3">
            ...
            <div className="aboutWrapper__social d-flex justify-content-around pb-2">
              {/*Github Social*/}
              <a
                href="https://github.com/Pablo2904"
              ...
              {/*Linkedin Social*/}
              <a
                href="https://www.linkedin.com/in/pawe%C5%82-ko%C5%9Bcielny-a73b65131/"
                rel="noopener noreferrer"
                target="_blank"
              >
